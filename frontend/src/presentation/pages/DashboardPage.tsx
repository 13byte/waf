    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="mb-6">
          ...
          <p className="text-gray-500 dark:text-gray-600">Real-time monitoring and threat analysis</p>
        </div>
        <div className="tabs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-800">Traffic Trends</h3>
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-800">Attack Distribution</h3>
          </div>
          {data.topAttackTypes.length > 0 ? (
                ...
                {data.topAttackTypes.slice(0, 3).map((attack, index) => (
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600 dark:text-gray-600">{attack.type}</span>
                    </div>
                    <span className="text-sm font-semibold text-gray-900 dark:text-gray-800">{attack.count}</span>
                  </div>
                ))}
              </div>
            </>
            ...
            <div className="h-48 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-600">No attacks detected</p>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-800">Top Source IPs</h3>
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-800">Recent Events</h3>
